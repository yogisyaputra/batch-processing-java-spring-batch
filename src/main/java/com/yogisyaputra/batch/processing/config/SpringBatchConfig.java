...
import com.yogisyaputra.batch.processing.repository.CustomerRepository;
...
public class SpringBatchConfig {
    ...
    public FlatFileItemReader<Customer> reader() {
        ...
        System.out.println("masuk reader ");
    ...
    private LineMapper<Customer> lineMapper() {
        ...
        System.out.println("masuk lineMapper ");
    ...
    @Bean
    public Step step1() {
        return stepBuilderFactory.get("csv-step").<Customer, Customer>chunk(1)
                .reader(reader())
                .processor(processor())
                .writer(writer())
                .build();
    ...
    public Job runJob() {
        ...
        System.out.println("masuk runJob");
